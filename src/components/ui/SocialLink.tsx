...
// lucide-react dropped trademarked brand marks (Github/Linkedin) from its
// icon set — these two are hand-drawn from the official brand SVGs instead
// of pulling in a separate icon-library dependency.
const GithubIcon = ({ size = 20 }: IBrandIconProps) => (
  <svg
...
const LinkedinIcon = ({ size = 20 }: IBrandIconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
